...
function createSlot3(ownerName) {
  ...
  const Slot22 = React10.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime8.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React10.isValidElement(newElement) ? React10.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React15.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React15.Children.count(newElement) > 1)
            return React15.Children.only(null);
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React18.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React18.Children.count(newElement) > 1)
            return React18.Children.only(null);
          return React18.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime14.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React18.isValidElement(newElement) ? React18.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var PopperAnchor = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime16.jsx)(Primitive4.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React21.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React21.Children.count(newElement) > 1)
            return React21.Children.only(null);
          return React21.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime17.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React21.isValidElement(newElement) ? React21.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Portal = React24.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime19.jsx)(Primitive5.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React25.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React25.Children.count(newElement) > 1)
            return React25.Children.only(null);
          return React25.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime20.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React25.isValidElement(newElement) ? React25.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive6 = NODES6.reduce((primitive, node) => {
  ...
  const Node2 = React26.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot10 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
function isSlottable8(child) {
  return React27.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER8;
}
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime25.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime25.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime25.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime25.jsx)(
...
var SelectIcon = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(Primitive6.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM10.createPortal(
        (0, import_jsx_runtime25.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime25.jsx)(Collection.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime25.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime25.jsx)(Combination_default, { as: Slot9, allowPinchZoom: true, children: (0, import_jsx_runtime25.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsxs)(import_jsx_runtime25.Fragment, { children: [
      ...
      (0, import_jsx_runtime25.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime25.jsx)(
        Primitive6.div,
        {
...
var SelectGroup = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime25.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime25.jsx)(Primitive6.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(Primitive6.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsxs)(import_jsx_runtime25.Fragment, { children: [
      (0, import_jsx_runtime25.jsx)(Primitive6.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime25.jsx)(Primitive6.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime25.jsx)(Primitive6.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
