...
export default {
  ...
  theme: {
    container: { // Requerido por shadcn
      center: true,
      padding: "2rem",
      screens: {
        "2xl": "1400px",
    ...
    extend: {
      ...
      borderRadius: { // Requerido por shadcn
        lg: "var(--radius)",
        md: "calc(var(--radius) - 2px)",
        sm: "calc(var(--radius) - 4px)",
      },
      keyframes: { // Requerido por shadcn
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: { // Requerido por shadcn
        "accordion-down": "accordion-down 0.2s ease-out",
        "accordion-up": "accordion-up 0.2s ease-out",
      },
      fontFamily: { // --- Nuestras Fuentes Personalizadas ---
