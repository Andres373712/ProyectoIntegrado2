...
import { Button } from '@/components/ui/button'; // Botón Shadcn
import { 
    Card, 
    CardContent, 
    CardFooter, 
    ...
    CardTitle,
    CardDescription
} from '@/components/ui/card'; // Tarjeta Shadcn
...
function Catalogo() {
  ...
  useEffect(() => {
    // Pedimos TODOS los talleres activos al backend
  ...
  return (
    <div className="bg-background text-foreground min-h-screen p-8 md:p-12">
      <div className="max-w-6xl mx-auto">
        ...
        {/* --- (Opcional) Aquí podríamos añadir filtros en el futuro --- */}
        ...
        {!cargando && talleres.length === 0 && (
            <p className="text-center text-lg text-foreground/70">
                No hay talleres activos en este momento. ¡Vuelve pronto!
            </p>
        )}
